...
while True:
    ...
    if re.search('your name|who are you', res):
        print("My name is Jarvis, I am your personal Virtual assistant Mr Rahul")
        t2s("My name is Jarvis, I am your personal Virtual  assistant Mr Rahul")
    if re.search('I love you ', res):
        print("Sorry i am committed")
        t2s("Sorry i am committed")
